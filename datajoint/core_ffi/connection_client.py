...
class Connection:
    def __init__(self, default_config=None, init_command=None, charset=None, sql_mode=None):
    ...
    def execute_query(self, query, arg_tuple):
    ...
    def fetch_query(self, query, arg_tuple):
        out = Cursor()
        if len(arg_tuple) == 0:
